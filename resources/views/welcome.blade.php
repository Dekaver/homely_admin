    ...
    <section class="mt-48 md:mt-40 pb-40 relative bg-blueGray-100">
      ...
      <div class="container mx-auto">
        <div class="flex flex-wrap items-center">
          ...
          >
            <div
              class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-red-600"
            >
              <img
                alt="..."
        ...
        <div class="flex flex-wrap items-center">
          <div class="w-full md:w-4/12 px-12 md:px-4 ml-auto mr-auto mt-48">
            ...
            <div class="block pb-6">
              <span
                class="text-xs font-semibold inline-block py-1 px-2 rounded-full text-blueGray-500 bg-white last:mr-0 mr-2 mt-2"
              >
                Buttons
              </span>
              <span

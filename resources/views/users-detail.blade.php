...
<x-app-layout>
  ...
  <div class="p-2 lg:p-8 w-full lg:flex">
    ...
    <div class="border-r border-b border-l border-grey-light lg:border-l-0 lg:border-t lg:border-grey-light bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal w-11/12">
      <div class="mb-8">
        ...
        <div class="text-black font-bold text-xl mb-2">{{$user->name}}</div>
        <p class="text-grey-darker text-base">{{$user->email}}</p>
      </div>
      <div class="flex items-center">
        <img class="w-10 h-10 rounded-full mr-4" src="https://pbs.twimg.com/profile_images/885868801232961537/b1F6H4KC_400x400.jpg" alt="Avatar of Jonathan Reinink">
        <div class="text-sm">
          <p class="text-black leading-none">Homely@gmail.com</p>
          <p class="text-grey-dark">Aug 31</p>
        </div>
      </div>
    </div>
  </div>

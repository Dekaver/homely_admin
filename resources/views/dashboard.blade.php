...
<div class="flex items-center justify-center p-6">
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4">
        <!-- 1 card -->
        <div class="relative bg-white p-6 rounded-3xl w-64 my-4 shadow-xl">
        ...
        <div class="relative bg-white p-6 rounded-3xl w-64 my-4 shadow-xl">
            <div class=" text-white flex items-center absolute rounded-full py-4 px-4 shadow-xl bg-green-500 left-4 -top-6">
                <!-- svg  -->
                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 163 89" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="15"
                        d="M 5.75,40.00
                            C 5.75,40.00 158.25,40.00 158.25,40.00
                                158.25,40.00 83.50,4.25 83.50,4.25
                                83.50,4.25 5.75,40.00 5.75,40.00 Z
                            M 24.00,42.00
                            C 24.00,42.00 23.91,85.45 23.91,85.45
                                23.91,85.45 137.24,85.45 137.24,85.45
                                137.24,85.45 137.33,42.00 137.33,42.00
                                137.33,42.00 24.00,42.00 24.00,42.00 Z
                            M 28.12,10.15
                            C 28.12,10.15 27.99,27.44 27.99,27.44
                                27.99,27.44 40.72,21.59 40.72,21.59
                                40.72,21.59 40.76,10.15 40.76,10.15
                                40.76,10.15 28.12,10.15 28.12,10.15 Z
                            M 162.00,41.33" />
                </svg>
            </div>
            <div class="mt-8">
                <p class="text-xl font-semibold my-2">Houses</p>
        ...
        <div class="relative bg-white p-6 rounded-3xl w-64 my-4 shadow-xl">
            <div class=" text-white flex items-center absolute rounded-full py-4 px-4 shadow-xl bg-blue-500 left-4 -top-6">
                <!-- svg  -->
                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="10 0 90 80" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="10" 
                    d="M 21.00,12.50
                    C 21.00,12.50 90.75,12.50 90.75,12.50
                        90.75,12.50 90.75,51.50 90.75,51.50
                        90.75,51.50 40.50,51.50 40.50,51.50
                        40.50,51.50 27.75,72.00 27.75,72.00
                        27.75,72.00 27.50,51.50 27.50,51.50
                        27.50,51.50 21.00,51.50 21.00,51.50
                        21.00,51.50 21.00,12.50 21.00,12.50 Z
                    M 39.27,32.96
                    C 39.27,32.96 39.24,30.11 39.24,30.11
                        39.24,30.11 42.69,30.11 42.69,30.11
                        42.69,30.11 42.69,32.93 42.69,32.93
                        42.69,32.93 39.27,32.96 39.27,32.96 Z
                    M 51.46,30.19
                    C 51.46,30.19 51.48,33.04 51.48,33.04
                        51.48,33.04 54.95,33.00 54.95,33.00
                        54.95,33.00 54.95,30.19 54.95,30.19
                        54.95,30.19 51.46,30.19 51.46,30.19 Z
                    M 65.77,30.30
                    C 65.77,30.30 65.80,33.13 65.80,33.13
                        65.80,33.13 69.30,33.11 69.30,33.11
                        69.30,33.11 69.27,30.24 69.27,30.24
                        69.27,30.24 65.77,30.30 65.77,30.30 Z
                    M 136.25,58.25" />
                </svg>
            </div>
            <div class="mt-8">
                <p class="text-xl font-semibold my-2">Pesan</p>
                <div class="flex space-x-2 text-gray-400 text-sm">
                    <!-- svg  -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
